...
```sh
uv run python skills/hg-presentation/scripts/segment_narration.py contents/2026/01-ai-agent-sw-vv-report --dry-run
uv run python skills/hg-presentation/scripts/segment_narration.py contents/2026/01-ai-agent-sw-vv-report
```
...
```sh
uv run python skills/hg-presentation/scripts/run_pipeline.py contents/2026/01-ai-agent-sw-vv-report --dry-run
```
