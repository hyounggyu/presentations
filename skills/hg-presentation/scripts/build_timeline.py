...
from project_config import load_project, relative_to_presentation, segment_audio_path, slide_audio_path, timeline_path
...
def estimated_segment_durations(slide_duration: float, texts: list[str], pauses_ms: list[int]) -> list[float]:
