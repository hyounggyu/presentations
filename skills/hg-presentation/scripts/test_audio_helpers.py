...
from project_config import Project, Segment, Slide, VideoConfig, VoiceConfig, segment_audio_path, slide_audio_path


class AudioHelperTests(unittest.TestCase):
    def make_project(self) -> Project:
        root = Path("/tmp/hg-presentations")
        ...
        return Project(
            ...
            voice=VoiceConfig(voice_id="voice", model_id="eleven_v3", output_format="mp3_44100_128"),
    ...
    def test_audio_paths(self) -> None:
        ...
        self.assertEqual(slide_audio_path(project, slide), project.presentation_dir / "build/voiceover/audio/slide-001.mp3")
