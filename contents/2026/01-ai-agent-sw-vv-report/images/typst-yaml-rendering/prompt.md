...
Create a 16:9 hand-drawn whiteboard style educational diagram. Show a YAML file on the left labeled "requirements.yaml". Show a Typst document/template in the center labeled "Typst". Show a rendered regulatory document on the right labeled "SRS Draft".
