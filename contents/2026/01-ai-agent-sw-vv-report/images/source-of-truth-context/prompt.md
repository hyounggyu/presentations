...
Right area label: "V&V Records". Add a small note: "domain-specific SoT". Show a structured, tidy source of reusable canonical data using organized cards, table rows, or a central data store. Include compact example cards or rows for requirements, architecture, detailed design, risk controls, tests, AI models, datasets, performance metrics, and documents.
